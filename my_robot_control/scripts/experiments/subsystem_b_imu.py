...
class Subsystem_B:
    ...
    def __init__(self):
        ...
        # EKF
        self.pos_y_ekf = 0
        self.ekf = ExtendedKalmanFilter(dim_x=3,dim_z=2) # x = [pos_y, vel_y, acc_y], z = [pos_y_old, acc_y_imu]
    ...
    def HJacobian_at(self, x):
        ...
        return array([[0, 0, 0],
                      [0, 0, 1]])              # dim = dim_x x dim_z

    def hx(self, x):
        """measurement function"""
        return array([0, x[2]])     # dim = dim_z
...
if __name__ == '__main__':
    try:
        ...
        while i < steps:
            ...
            z = array([0, subsystem_b.acc_y_imu]) 
