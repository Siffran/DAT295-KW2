...
if __name__ == "__main__":
    ...
    df.to_csv('main_imu_wheel_gps_laser.csv') 
    ...
    plt.plot(recorded_positions["Time"], recorded_positions["Laser x"], color="purple", alpha=0.7, label="Laser pos")
    ...
    plt.plot(recorded_positions["Time"], recorded_positions["Laser y"], color="purple", alpha=0.7, label="Laser pos")
